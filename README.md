...
Реализация основных функций библиотеки String.h + реализация функции sprintf() c различными флагами. Также написаны юнит тесты к каждой функции с покрытие не менее 80% кода. Утечки памяти проверены с помощью Valgrind
...
- Unit-тесты проверяют результаты работы нашей реализации путём ее сравнения с реализацией стандартной библиотеки string.h
